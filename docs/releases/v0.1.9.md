...
### ✅ Enhanced SSH Key Error Messages
...
### ✅ Daemon Settings UI Improvements
...
**Tunnel Types**
- ❌ Remote port forwarding (`ssh -R`) - Planned for future release
- ❌ Dynamic/SOCKS proxy (`ssh -D`) - Planned for future release
- ❌ Auto-reconnect/health monitoring - Config exists but not wired

**GUI Features**
- ❌ System tray integration
- ❌ Desktop notifications
- ❌ Profile autostart configuration
...
✅ **Always use HTTPS for network access** - HTTP mode is restricted to loopback
✅ **Keep auth tokens secure** - Use 0600 permissions on `cli.toml`
✅ **Use TLS fingerprint pinning** - Prevents MITM attacks
✅ **SSH keys stay on daemon** - Never transmitted over network in hybrid mode
