...
**System Integration**
- ❌ No official packages yet (Flatpak, AUR, .deb, AppImage)
...
**Documentation Gaps**
- ⚠️ No migration guide for upgrading between versions
...
- ⚠️ Malicious processes running as the same user (by design - Unix permission model)
  ...
  - Mitigation: Use antivirus/security tools to prevent malware from running as your user
